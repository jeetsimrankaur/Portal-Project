...
<font size=8 color="green" >Notices.......</font>
        ...
        <table border=0 width=800 align="center" cellspacing="18">
            <tr>
          ...
          while(rs.next())
              {
                    ...
                    if(request.getParameter("id")!=null &&  request.getParameter("id").equals(rs.getString(1)) )
                        out.print("<form name=ff method=post action=updatetnotice.jsp?id="+rs.getString(1)+" ><tr height=40 bgcolor=yellow ><td>"+rs.getString(2)+"</td><td>"+rs.getString(4)+"</td><td><input type=checkbox name=chk1 "+(rs.getString(6).equals("1")?" checked ":"" )+"  ></td><td align=center><input type=submit value=save > - <input type=button value=cancel onclick=\"window.location='tnotice.jsp'\"></td></tr></form>"); 
                    else
                        out.print("<tr><td>"+rs.getString(2)+"</td><td>"+rs.getString(4)+"</td><td><input type=checkbox name=chk1 "+(rs.getString(6).equals("1")?" checked ":"" )+" disabled ></td>"+(rs.getString(3).equals(session.getAttribute("tid"))?"<td align=center><a href=tnotice.jsp?id="+rs.getString(1)+" >edit </a> - <a href=deletetnotice.jsp?id="+rs.getString(1)+" >delete</a></td>":"<td></td>")+"</tr>");
              }
        ...
        <br><br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="twelcome.jsp">Back to Welcome Page</a>
